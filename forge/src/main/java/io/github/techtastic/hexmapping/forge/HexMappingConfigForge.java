...
public class HexMappingConfigForge {
    ...
    public static void init() {
        ...
        HexMappingConfig.setCommon(config.getLeft());
        HexMappingConfig.setClient(clientConfig.getLeft());
        HexMappingConfig.setServer(serverConfig.getLeft());
    ...
    public static class Common implements HexMappingConfig.CommonConfigAccess {
        public Common(ForgeConfigSpec.Builder builder) {

        }
    }

    public static class Client implements HexMappingConfig.ClientConfigAccess {
        public Client(ForgeConfigSpec.Builder builder) {

        }
    }

    public static class Server implements HexMappingConfig.ServerConfigAccess {
        // costs of actions
        private static ForgeConfigSpec.DoubleValue congratsCost;
        private static ForgeConfigSpec.DoubleValue signumCost;

        public Server(ForgeConfigSpec.Builder builder) {
            builder.translation("text.autoconfig.hexmapping.option.server.costs").push("costs");

            congratsCost = builder.translation("text.autoconfig.hexmapping.option.server.costs.congratsCost").defineInRange("congratsCost", DEFAULT_CONGRATS_COST, DEF_MIN_COST, DEF_MAX_COST);
            signumCost = builder.translation("text.autoconfig.hexmapping.option.server.costs.signumCost").defineInRange("signumCost", DEFAULT_SIGNUM_COST, DEF_MIN_COST, DEF_MAX_COST);
